...
# Load data
pos_train_data = './seq_data/pos_retrain2_ds2.fasta'
neg_train_data = './seq_data/neg_retrain2_ds2.fasta'
pos_valid_data = './seq_data/pos_valid2_ds2.fasta'
neg_valid_data = './seq_data/neg_valid2_ds2.fasta'
pos_test_data = './seq_data/pos_test_ds2.fasta'
neg_test_data = './seq_data/neg_test_ds2.fasta'
...
pc6_valid_features, pc6_valid_labels = get_PC6_features_labels(pos_valid_data, neg_valid_data,length=100)
reshape_pc6_valid_features = pc6_valid_features.reshape(pc6_valid_features.shape[0],-1)

pc6_test_features, pc6_test_labels = get_PC6_features_labels(pos_test_data, neg_test_data,length=100)
...
doc2vec_valid_features, doc2vec_valid_labels = get_Doc2Vec_features_labels(pos_valid_data, neg_valid_data, './Doc2Vec_model/AFP_doc2vec_DS2.model')
...
doc2vec_test_features, doc2vec_test_labels = get_Doc2Vec_features_labels(pos_test_data, neg_test_data, './Doc2Vec_model/AFP_doc2vec_DS2.model')
...
bert_train_features, bert_train_labels = get_bert_features_labels(pos_train_data, neg_train_data, 'Rostlab/prot_bert_bfd', MAX_LEN=105)
bert_valid_features, bert_valid_labels = get_bert_features_labels(pos_valid_data, neg_valid_data, 'Rostlab/prot_bert_bfd', MAX_LEN=105)
bert_test_features, bert_test_labels = get_bert_features_labels(pos_test_data, neg_test_data, 'Rostlab/prot_bert_bfd', MAX_LEN=105)
...
# Create directory
if not os.path.isdir('ensemble_model/DS2'):
    os.makedirs('ensemble_model/DS2/pc6')
    os.makedirs('ensemble_model/DS2/doc2vec')
    os.makedirs('ensemble_model/DS2/bert')

# PC6 model
# SVM
pc6_svc = svm.SVC()
pc6_svc_fit = pc6_svc.fit(reshape_pc6_train_features, pc6_train_labels)
joblib.dump(pc6_svc, './ensemble_model/DS2/pc6/pc6_features_svm_DS2.pkl')

pc6_svc = joblib.load('./ensemble_model/DS2/pc6/pc6_features_svm_DS2.pkl')
...
joblib.dump(pc6_forest, './ensemble_model/DS2/pc6/pc6_features_forest_DS2.pkl')

pc6_forest = joblib.load('./ensemble_model/DS2/pc6/pc6_features_forest_DS2.pkl')
...
pc6_t_m = train_pc6_model(pc6_train_data_, pc6_train_labels_, pc6_test_data_, pc6_test_labels_, 'ensemble', path = './ensemble_model/DS2/pc6')
learning_curve(pc6_t_m.history)

pc6_cnn_model = load_model('./ensemble_model/DS2/pc6/ensemble_best_weights_DS2.h5')
...
joblib.dump(doc2vec_svc, './ensemble_model/DS2/doc2vec/doc2vec_features_svm_DS2.pkl')

doc2vec_svc = joblib.load('./ensemble_model/DS2/doc2vec/doc2vec_features_svm_DS2.pkl')
...
joblib.dump(doc2vec_forest, './ensemble_model/DS2/doc2vec/doc2vec_features_forest_DS2.pkl')

doc2vec_forest = joblib.load('./ensemble_model/DS2/doc2vec/doc2vec_features_forest_DS2.pkl')
...
doc2vec_t_m = train_doc2vec_model(doc2vec_train_data_, doc2vec_train_labels_, doc2vec_test_data_, doc2vec_test_labels_, 'ensemble', path = './ensemble_model/DS2/doc2vec')
learning_curve(doc2vec_t_m.history)

doc2vec_cnn_model = load_model('./ensemble_model/DS2/doc2vec/ensemble_best_weights_DS2.h5')
...
# BERT model
bert_labels = get_bert_prediction(pos_train_data, neg_train_data, pos_valid_data, neg_valid_data, 'Rostlab/prot_bert_bfd', './ensemble_model/DS2/bert', MAX_LEN=105)
bert_labels_score = run_bert_prediction(pos_valid_data, neg_valid_data, 'Rostlab/prot_bert_bfd', './ensemble_model/DS2/bert', MAX_LEN=105)
...
from model_DS2 import train_ensemble_model
...
e_m = train_ensemble_model(ensembleX, ensembleY, 'ensemble', path = './ensemble_model/DS2')
...
bert_test_score = run_bert_prediction(pos_test_data, neg_test_data, 'Rostlab/prot_bert_bfd', './ensemble_model/DS2/bert', MAX_LEN=105)
...
for i in range(in_size):
    ...
    if(doc2vec_cnn_test_score[i][0] >= 0.5):
        score_list.append(float('1'))
    else:
        score_list.append(float('0'))
...
ensemble_model = load_model('./ensemble_model/DS2/ensemble_best_weights_DS2.h5')
